...
******************************************************************************/
#define PRODUCT_KEY "fnenlza0jdftpze3"    //The unique product identification generated after product is created on development platform
...
//点动开关（延时关）(可下发可上报)
//Notes:#1控制（bit0--开关，bit7-bit1---通道号）/#2星期/#3#4起始时间(min)/#5#6结束时间(min)
#define DPID_SWITCH_INCHING 19
//Backlight intensity(可下发可上报)
//Notes:
#define DPID_BACKLIGHT 101
//Colour(可下发可上报)
//Notes:
